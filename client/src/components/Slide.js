        ...
        <Slider {...settings}>
            <div className="slide-box one">
                <div className="img-box">
                    <img src={`${process.env.PUBLIC_URL}/images/bg_1_s.png`} alt="CU 연세우유 말차생크림빵" />
                </div>
            ...
            <div className="slide-box two">
                <div className="img-box">
                <img src={`${process.env.PUBLIC_URL}/images/bg_2_s.png`} alt="7-Eleven 산리오 캐릭터즈 푸드 에디션"/>
                </div>
                <div className="text-box blind">
            ...
            <div className="slide-box three">
                <div className="img-box">
                <img src={`${process.env.PUBLIC_URL}/images/bg_3_s.png`} alt="GS25 혜자로운집밥 도시락 시리즈" />
                </div>
                <div className="text-box blind">
                    <h1>집밥처럼 맛있고 푸짐하게!</h1>
